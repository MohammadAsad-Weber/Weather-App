const url = `https://api.openweathermap.org/data/2.5/weather?q=Delhi,India&appid=000ce18614a4c0e03de1d9fd70a2882a&units=metric`;
...
function Search() {
    async function Retrieve() {
        if (Input.value !== ``) {
            ...
            try {
                const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${Input.value}&appid=000ce18614a4c0e03de1d9fd70a2882a&units=metric`);
                const data = await response.json();
